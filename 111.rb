...
#Error: 111.rb:18:in `/': divided by 0 (ZeroDivisionError) from 111.rb:18:in `<main>'
# The computer recognises that a number cannot be divded by 0 so it says 'divided by 0' on line 18.